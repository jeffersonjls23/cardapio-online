...
if TOKEN_CSRF:
    ...
    CSRF_TRUSTED_ORIGINS = ['https://cardapio-online-production-3409.up.railway.app']
else:
...
ALLOWED_HOSTS = ["cardapio-online-production-3409.up.railway.app", "localhost", "127.0.0.1"]
